...
class LoginScreen implements IPackage
{
    ...
    {
        add_action('customize_register', __CLASS__.'::registerCustomizerOptions');
        add_action('login_enqueue_scripts', __CLASS__.'::customizeLoginScreen');
    }
    
    public static function registerCustomizerOptions($wp_customize)
    {
    ...
    public static function customizeLoginScreen()
    {
        ...
        <style type="text/css">
            ...
            #wp-submit:hover {
                background-color: <?php echo self::darkenColor($buttonBackgroundColor); ?>;
            }
            ...
            #login #nav a:hover, #login #backtoblog a:hover {
                border-bottom: 1px solid<?php echo self::darkenColor($linkColor); ?>;
            }
        </style>
        <?php
    }
    
    private static function darkenColor($rgb)
    {
