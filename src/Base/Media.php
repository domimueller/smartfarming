...
class Media
{
    ...
    public function getUikitImage($size = null, $attr = null)
    {
        ...
        $image .= Media::getImageSrcsetSizes(true) . ' ';
     ...
     * @version 1.0.0
     */
    public static function getImageSrcsetSizes($isUikit = false)
    {
        return ($isUikit ? 'data-' : '') . 'sizes="(min-width: ' . Media::LARGE . 'px) ' . Media::LARGE . 'px, (min-width: ' . Media::MEDIUM . 'px) ' . Media::LARGE . 'px, 100vw"';
    }
