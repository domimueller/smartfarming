...
class PackageController extends ABaseController
{
    ...
    private const FRONTEND_PACKAGES = [
        \Cubetech\Packages\Frontend\LoginScreen::class,
        \Cubetech\Packages\Frontend\CubetechPerformanceCenter::class,
        \Cubetech\Packages\Frontend\GravityForm::class,
        \Cubetech\Packages\Frontend\Shortcodes::class,
        \Cubetech\Packages\Frontend\LazyLoad::class,
        \Cubetech\Packages\Backend\CubetechWP_CLI::class,
    ];
     ...
     * @var array
     */
    private const BACKEND_PACKAGES = [
        \Cubetech\Packages\Backend\Dashboard::class,
        \Cubetech\Packages\Backend\CubetechPostCacher::class,
    ];
